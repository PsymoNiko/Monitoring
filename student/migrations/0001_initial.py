    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personality', models.CharField(choices=[('INTP', 'INTP'), ('INTJ', 'INTJ'), ('ENTJ', 'ENTJ'), ('ENTP', 'ENTP'), ('INFJ', 'INFJ'), ('INFP', 'INFP'), ('ENFJ', 'ENFJ'), ('ENFP', 'ENFP'), ('ISTJ', 'ISTJ'), ('ISFJ', 'ISFJ'), ('ESTJ', 'ESTJ'), ('ESFJ', 'ESFJ'), ('ISTP', 'ISTP'), ('ISFP', 'ISFP'), ('ESTP', 'ESTP'), ('ESFP', 'ESFP')], max_length=4)),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='profile_images/')),
                ('created_at', models.DateField(auto_now_add=True)),
                ('modified_at', models.DateField(auto_now=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_course', to='ceo.course')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_to', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='student.student')),
                ('mentor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='mentor.mentor')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='admin_payments', to='student.student')),
            ],
        ),
    ]
